...
const DataAssetSchema = new mongoose.Schema({
  ...
  type: {
    ...
    enum: ['API', 'Business Term', 'Column', 'Dashboard', 'Data Lake', 'Data Pipeline', 'Data Warehouse', 'Database', 'Dataset', 'Document', 'ETL Process', 'File', 'Index', 'Report', 'Schema', 'Table', 'View']
  },
  domain: {
    type: String,
